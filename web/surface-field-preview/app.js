...
const {
  ...
  regionLabelForCode,
  scenarioInfo,
} = window.RustyOpticsPlanarian3DReadouts;
...
const planarian3dExport = window.RustyOpticsPlanarian3DExport.createPlanarian3DExportController({
  clearPlanarian3DInteractionStateWithoutView,
  controls,
  encoderUrls: {
    apng: apngEncoderModuleUrl,
    gif: gifEncoderModuleUrl,
    video: videoEncoderModuleUrl,
  },
  formatPlanarianSourceTargetAnchor,
  getState: () => ({
    planarian3dRuntime,
...
controls.exportPlanarianGif.addEventListener("click", () => {
  planarian3dExport.exportPlanarian3DGif();
});
